...
public final class DateUtils {
	 ...
	 * @param formatYearMonthDay
	 *            The format containing the year, the month and the day.
	 * @param formatYearMonth
	 *            The format containing the year and the month.
	 * @param formatYear
	 *            The format containing only the year.
	 * @param locale
	 *            The locale to be used during the attempts to parse.
