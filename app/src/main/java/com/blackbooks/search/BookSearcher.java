...
public final class BookSearcher {
     ...
     * otherwise.
     * @throws IOException          If any book search threw an IOException (most likely because
     ...
     *
     * @param futureSearchResultList List of future {@link BookSearchResult}.
     * @return List of {@link BookSearchResult}.
     * @throws InterruptedException If a book search was interrupted.
     * @throws IOException          If a book search failed because an IOException was thrown.
     */
     ...
     * {@link BookInfo}.
     *
     * @param bookSearchResultList List of {@link BookSearchResult}.
