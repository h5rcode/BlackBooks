...
public abstract class EditableArrayAdapter<T> extends ArrayAdapter<T> {
     ...
     * @param resource   Id of the list view of the adapter.
     * @param layoutItem Id of the layout that will be used to render each item of the
     *                   list.
     * @param textViewId Id of the text view where the label of each item will be
     *                   rendered.
     * @param buttonId   Id of the button of each row of the list.
     * @param objects    The initial list of objects to display.
     */
