...
public class ScannedIsbn implements Serializable {
    ...
    @Column(name = Cols.SCI_SEARCH_SUCCESSFUL, mandatory = true, type = SQLiteDataType.INTEGER, version = 3)
    ...
    public static final class Cols {
        ...
        public static final String SCI_SEARCH_SUCCESSFUL = "SCI_SEARCH_SUCCESSFUL";
    }
}
